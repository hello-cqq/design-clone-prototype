...
2. Publish (creates the PR for you):
   `node <design-clone-skill>/scripts/publish.mjs --run <runDir> --app <app> --flavor <flavor> --title "<title>"`
...
4. After merge your prototype is live at
   `https://hello-cqq.github.io/design-clone-prototype/<app>/<flavor>/prototype/`
